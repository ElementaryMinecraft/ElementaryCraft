		...
		if ((!((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).abilities.isCreativeMode : false))) {
			if (((EnchantmentHelper.getEnchantmentLevel(Enchantments.SILK_TOUCH,
				...
				if (!world.getWorld().isRemote) {
					ItemEntity entityToSpawn = new ItemEntity(world.getWorld(), x, y, z, new ItemStack(GluonFieldItem.block, (int) (1)));
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), GluonFieldItem.block.getDefaultState(), 3);
			}
		}
