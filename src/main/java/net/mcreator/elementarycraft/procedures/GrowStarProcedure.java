...
public class GrowStarProcedure extends ElementaryCraftModElements.ModElement {
	public GrowStarProcedure(ElementaryCraftModElements instance) {
		super(instance, 181);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (!world.getWorld().isRemote) {
			...
			if (_tileEntity != null)
				_tileEntity.getTileData().putBoolean("NotPlacedBlock", (true));
		...
		if (!world.getWorld().isRemote) {
			...
			BlockState _bs = world.getBlockState(_bp);
			if (_tileEntity != null)
				_tileEntity.getTileData().putDouble("iteration", 0);
			world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
		}
		while ((new Object() {
			...
			if (((new Object() {
				...
				if (((world.getBlockState(new BlockPos((int) (x + (new Object() {
					...
					if (!world.getWorld().isRemote) {
						...
						BlockState _bs = world.getBlockState(_bp);
						if (_tileEntity != null)
							_tileEntity.getTileData().putBoolean("NotPlacedBlock", (false));
						world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
					}
				} else {
					if (((world.getBlockState(new BlockPos((int) (x + (new Object() {
