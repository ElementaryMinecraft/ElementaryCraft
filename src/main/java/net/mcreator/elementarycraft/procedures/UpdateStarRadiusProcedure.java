	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ElementaryCraftMod.LOGGER.warn("Failed to load dependency x for procedure UpdateStarRadius!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ElementaryCraftMod.LOGGER.warn("Failed to load dependency y for procedure UpdateStarRadius!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ElementaryCraftMod.LOGGER.warn("Failed to load dependency z for procedure UpdateStarRadius!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ElementaryCraftMod.LOGGER.warn("Failed to load dependency world for procedure UpdateStarRadius!");
			return;
		}
		...
		if (((new Object() {
			...
			if (!world.getWorld().isRemote) {
				...
				BlockState _bs = world.getBlockState(_bp);
				if (_tileEntity != null)
					_tileEntity.getTileData().putDouble("NBlocksInSphere", 0);
				world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
			}
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					...
					for (int index2 = 0; index2 < (int) ((((new Object() {
						...
						if (((new Object() {
							...
							if (!world.getWorld().isRemote) {
								...
								BlockState _bs = world.getBlockState(_bp);
								if (_tileEntity != null)
									_tileEntity.getTileData().putDouble("NBlocksInSphere", ((new Object() {
										public double getValue(IWorld world, BlockPos pos, String tag) {
											TileEntity tileEntity = world.getTileEntity(pos);
											if (tileEntity != null)
												return tileEntity.getTileData().getDouble(tag);
									...
									}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "NBlocksInSphere")) + 1));
								world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
							}
						}
						if (!world.getWorld().isRemote) {
