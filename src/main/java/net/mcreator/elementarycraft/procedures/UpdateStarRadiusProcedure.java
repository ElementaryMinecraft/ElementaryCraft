	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				System.err.println("Failed to load dependency x for procedure UpdateStarRadius!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				System.err.println("Failed to load dependency y for procedure UpdateStarRadius!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				System.err.println("Failed to load dependency z for procedure UpdateStarRadius!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				System.err.println("Failed to load dependency world for procedure UpdateStarRadius!");
			return;
		}
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "radius")) < 7)) {
			if (!world.getWorld().isRemote) {
				BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
				TileEntity _tileEntity = world.getTileEntity(_bp);
				BlockState _bs = world.getBlockState(_bp);
						...
						if (((new Object() {
							...
							if (!world.getWorld().isRemote) {
								...
								if (_tileEntity != null)
									...
									}.getValue(new BlockPos((int) x, (int) y, (int) z), "NBlocksInSphere")) + 1));
								world.getWorld().notifyBlockUpdate(_bp, _bs, _bs, 3);
							}
						}
						if (!world.getWorld().isRemote) {
