		...
		if ((!((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).abilities.isCreativeMode : false))) {
			if (((EnchantmentHelper.getEnchantmentLevel(Enchantments.SILK_TOUCH,
				...
				if (!world.getWorld().isRemote) {
					ItemEntity entityToSpawn = new ItemEntity(world.getWorld(), x, y, z, new ItemStack(UpQuarkFieldItem.block, (int) (1)));
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), UpQuarkFieldItem.block.getDefaultState(), 3);
			}
		}
