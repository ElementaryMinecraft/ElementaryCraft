...
public class PositronAnnihilateProcedure extends ElementaryCraftModElements.ModElement {
	public PositronAnnihilateProcedure(ElementaryCraftModElements instance) {
		super(instance, 60);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure PositronAnnihilate!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure PositronAnnihilate!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure PositronAnnihilate!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure PositronAnnihilate!");
			return;
		}
		...
		}.getValue(new BlockPos((int) x, (int) y, (int) z), "electronNgbr"))) {
