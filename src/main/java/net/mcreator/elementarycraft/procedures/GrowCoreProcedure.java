	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				ElementaryCraftMod.LOGGER.warn("Failed to load dependency x for procedure GrowCore!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				ElementaryCraftMod.LOGGER.warn("Failed to load dependency y for procedure GrowCore!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				ElementaryCraftMod.LOGGER.warn("Failed to load dependency z for procedure GrowCore!");
			return;
		}
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				ElementaryCraftMod.LOGGER.warn("Failed to load dependency world for procedure GrowCore!");
			return;
		}
		...
		if (!world.getWorld().isRemote) {
			...
			if (_tileEntity != null)
				...
				}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "radius")) + 1));
		...
		if ((((new Object() {
			...
			}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "lifeStage"))))) {
				if (!world.getWorld().isRemote) {
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					TileEntity _tileEntity = world.getTileEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
					...
					for (int index1 = 0; index1 < (int) ((((new Object() {
						...
						for (int index2 = 0; index2 < (int) ((((new Object() {
							...
							if (((new Object() {
								...
								if (((new Object() {
								...
								}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "lifeStage")) == 1)) {
									...
									if (((new Object() {
									...
									}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "lifeStage")) == 2)) {
										if (((world.getBlockState(new BlockPos((int) (x + (new Object() {
											public double getValue(IWorld world, BlockPos pos, String tag) {
												TileEntity tileEntity = world.getTileEntity(pos);
												if (tileEntity != null)
										...
										}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "zcoord")))))).getBlock() == Blocks.COAL_BLOCK
												.getDefaultState().getBlock())) {
											{
												BlockPos _bp = new BlockPos((int) (x + (new Object() {
													public double getValue(IWorld world, BlockPos pos, String tag) {
										...
										if (((new Object() {
										...
										}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "lifeStage")) == 3)) {
											if (((world.getBlockState(new BlockPos((int) (x + (new Object() {
												public double getValue(IWorld world, BlockPos pos, String tag) {
													TileEntity tileEntity = world.getTileEntity(pos);
													if (tileEntity != null)
											...
											}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "zcoord")))))).getBlock() == SiliconBlock.block
													.getDefaultState().getBlock())) {
												{
													BlockPos _bp = new BlockPos((int) (x + (new Object() {
														public double getValue(IWorld world, BlockPos pos, String tag) {
