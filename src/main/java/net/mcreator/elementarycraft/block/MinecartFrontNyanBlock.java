...
public class MinecartFrontNyanBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:minecart_front_nyan")
	public static final Block block = null;
	public MinecartFrontNyanBlock(ElementaryCraftModElements instance) {
		super(instance, 216);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minecart_front_nyan");
		}
