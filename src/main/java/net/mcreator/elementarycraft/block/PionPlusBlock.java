...
public class PionPlusBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:pion_plus")
	public static final Block block = null;
	@ObjectHolder("elementary_craft:pion_plus")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PionPlusBlock(ElementaryCraftModElements instance) {
		super(instance, 24);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("pion_plus"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("pion_plus");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Pion Plus");
		}
