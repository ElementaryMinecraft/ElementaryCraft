...
public class MinecartFrontUpRedBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:minecart_front_up_red")
	public static final Block block = null;
	public MinecartFrontUpRedBlock(ElementaryCraftModElements instance) {
		super(instance, 203);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minecart_front_up_red");
		}
