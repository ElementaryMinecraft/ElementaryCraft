...
public class StrechedGluonXBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:streched_gluon_x")
	public static final Block block = null;
	public StrechedGluonXBlock(ElementaryCraftModElements instance) {
		super(instance, 130);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("streched_gluon_x");
		}
