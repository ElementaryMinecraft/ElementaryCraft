...
import net.mcreator.elementarycraft.procedures.NeutrinoQuantumfieldBlockDestroyedByPlayerProcedure;
...
public class NeutrinoQuantumfieldBlock extends ElementaryCraftModElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry()
				.register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("neutrino_quantumfield"));
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				NeutrinoQuantumfieldBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("neutrino_quantumfield");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Neutrino Quantumfield");
		}
...
import net.mcreator.elementarycraft.procedures.NeutrinoQuantumfieldDropProcedure;
import net.mcreator.elementarycraft.itemgroup.QuantumfieldItemGroup;
import net.mcreator.elementarycraft.ElementaryCraftModElements;
