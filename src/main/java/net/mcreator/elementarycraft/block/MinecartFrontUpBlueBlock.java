...
public class MinecartFrontUpBlueBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:minecart_front_up_blue")
	public static final Block block = null;
	public MinecartFrontUpBlueBlock(ElementaryCraftModElements instance) {
		super(instance, 157);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minecart_front_up_blue");
		}
