...
import net.mcreator.elementarycraft.procedures.SpontaneousDihydrogenProcedure;
...
public class HydrogenBlock extends ElementaryCraftModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			}
			{
				...
				SpontaneousDihydrogenProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
