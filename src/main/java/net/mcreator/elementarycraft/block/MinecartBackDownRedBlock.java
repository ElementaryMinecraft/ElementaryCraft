...
public class MinecartBackDownRedBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:minecart_back_down_red")
	public static final Block block = null;
	public MinecartBackDownRedBlock(ElementaryCraftModElements instance) {
		super(instance, 209);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minecart_back_down_red");
		}
