...
public class PionMinusBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:pion_minus")
	public static final Block block = null;
	@ObjectHolder("elementary_craft:pion_minus")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PionMinusBlock(ElementaryCraftModElements instance) {
		super(instance, 23);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("pion_minus"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("pion_minus");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Pion Minus");
		}
