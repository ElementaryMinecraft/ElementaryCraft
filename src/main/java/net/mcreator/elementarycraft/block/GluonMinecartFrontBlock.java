...
public class GluonMinecartFrontBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:gluon_minecart_front")
	public static final Block block = null;
	public GluonMinecartFrontBlock(ElementaryCraftModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gluon_minecart_front");
		}
