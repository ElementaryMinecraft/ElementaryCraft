...
public class MinecartBackUpGreenBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:minecart_back_up_green")
	public static final Block block = null;
	public MinecartBackUpGreenBlock(ElementaryCraftModElements instance) {
		super(instance, 170);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minecart_back_up_green");
		}
