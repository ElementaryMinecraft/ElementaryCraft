...
public class GluonMinecartBackBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:gluon_minecart_back")
	public static final Block block = null;
	public GluonMinecartBackBlock(ElementaryCraftModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("gluon_minecart_back");
		}
