...
public class MinecartBackUpBlueBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:minecart_back_up_blue")
	public static final Block block = null;
	public MinecartBackUpBlueBlock(ElementaryCraftModElements instance) {
		super(instance, 169);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("minecart_back_up_blue");
		}
