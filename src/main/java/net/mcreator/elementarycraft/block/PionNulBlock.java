...
public class PionNulBlock extends ElementaryCraftModElements.ModElement {
	@ObjectHolder("elementary_craft:pion_nul")
	public static final Block block = null;
	@ObjectHolder("elementary_craft:pion_nul")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public PionNulBlock(ElementaryCraftModElements instance) {
		super(instance, 25);
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("pion_nul"));
	}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("pion_nul");
		}
		...
		public ITextComponent getDisplayName() {
			return new StringTextComponent("Pion Nul");
		}
