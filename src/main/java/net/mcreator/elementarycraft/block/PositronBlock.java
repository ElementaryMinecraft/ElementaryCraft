...
import net.mcreator.elementarycraft.procedures.PositronAnnihilateProcedure;
...
public class PositronBlock extends ElementaryCraftModElements.ModElement {
	...
	public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
		event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("positron"));
	}
	...
	public static class CustomBlock extends Block {
		...
		public void neighborChanged(BlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			}
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				PositronAnnihilateProcedure.executeProcedure($_dependencies);
			}
		}
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("positron");
		}
