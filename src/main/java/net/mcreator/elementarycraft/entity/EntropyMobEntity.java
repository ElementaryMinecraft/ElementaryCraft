...
package net.mcreator.elementarycraft.entity;
...
import net.mcreator.elementarycraft.procedures.EntropyMobSpawnProcedure;
import net.mcreator.elementarycraft.procedures.EntropyMobCollidesWithPlayerProcedure;
import net.mcreator.elementarycraft.gui.EntropyGUIGui;
...
public class EntropyMobEntity extends ElementaryCraftModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.6f, 1.7f)).build("entropy_mob")
						.setRegistryName("entropy_mob");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("entropy_mob"));
	}
	...
	public static class CustomEntity extends CreeperEntity {
		...
		public ILivingEntityData onInitialSpawn(IWorld world, DifficultyInstance difficulty, SpawnReason reason, ILivingEntityData livingdata,
			...
			Entity entity = this;
			{
				...
				EntropyMobSpawnProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		private final ItemStackHandler inventory = new ItemStackHandler(125) {
			@Override
			...
			if (sourceentity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) sourceentity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Entropy Mob");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new EntropyGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			double z = this.getPosZ();
			{
				...
				EntropyMobCollidesWithPlayerProcedure.executeProcedure($_dependencies);
			}
		}
